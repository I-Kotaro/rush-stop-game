...
function getEvaluation(finalScore) {
    if (finalScore >= 4500) {
        ...
        return "標準的な勤務成績です。<br>もう少し駆け込み乗車を阻止できれば、さらにダイヤが安定します。";
    }
    else if (finalScore >= 0) {
        return "お疲れ様でした。<br>少し遅延が目立ちます。素早く移動して、確実に駆け込みを阻止しましょう。";
    }
    else {
        return "ダイヤ崩壊！始末書レベルの大遅延が発生しています！<br>安全かつ迅速な乗降誘導を心掛けてください！";
    }
}
// --- イベントリスナー ---
// マウスの動きに合わせて駅員を「横移動」
